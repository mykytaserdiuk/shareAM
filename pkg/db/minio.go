...
type Storage interface {
	Upload(ctx context.Context, bucket, object, token string, reader io.Reader, size int64) error
...
func (m *MinioDB) ConfigureBucket(ctx context.Context, bucket string) error {
	m.bucket = bucket
...
func (m *MinioDB) GetLinkFromFile(_ context.Context, file *models.File) string {
